        ...
        >
          {[
            ...
            <motion.a
              ...
              className="w-10 h-10 text-blue-900 dark:text-white backdrop-blur-sm border border-white/20 rounded-full flex items-center justify-center   hover:bg-white/20 transition-all duration-300"
